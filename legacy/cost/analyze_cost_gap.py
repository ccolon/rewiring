...
Reads every CSV in this script's directory and writes the figures
into the same directory. Run from anywhere:

    python results/cost_gap/analyze_cost_gap.py
    python results/cost_gap/analyze_cost_gap.py --output some/other/dir
"""
import argparse
import glob
import json
...
def main():
    ...
    p.add_argument('--output', default=None,
                   help='Output figures dir (default: this script\'s folder).')
    args = p.parse_args()

    # CSVs and figures both live in the same folder as this script,
    # regardless of the caller's CWD.
    data_dir = SCRIPT_DIR
    out_dir = args.output or SCRIPT_DIR
